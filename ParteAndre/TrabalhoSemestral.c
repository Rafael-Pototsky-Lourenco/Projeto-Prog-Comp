...
{
    int escolha = 0, i, j, idExcluir, escolhaJogo = 0, quantidadeJogo[1] = {0}, idCompra = 0;
    char apague, compra;
            ...
            while (escolhaJogo != 4)
            {
                ...
                case 1:
                    for (i = 0; i < contas; i++)
                    {
                        ...
                        scanf("%f", &cs[i].saldo);
                        cs[i].saldo = cs[i].saldo + cs[i].saldo;
                    }
                ...
                case 2:
                    ...
                    for (i = 0; i < jogos; i++)
                    {
                        if (idCompra == cg[i].codigoJogo)
                        {
                            ...
                            {
                                if (cs[i].saldo >= cg[i].precoJogo)
                                {
                                    printf("Compra efetuada para a conta.\n");
                                    cs[i].saldo = cs[i].saldo - cg[i].precoJogo;
                                    printf("Saldo restante: %.2f\n", cs[i].saldo);
                                    quantidadeJogo[i]++;
                                    break;
                                }
                                else if (cs[i].saldo <= cg[i].precoJogo)
                                {
