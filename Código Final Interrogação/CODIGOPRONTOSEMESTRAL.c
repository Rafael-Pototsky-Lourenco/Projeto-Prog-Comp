    ...
    while (escolha != 5)
    {
        ...
        switch (escolha)
        {
            ...
            case 3:
            {
                ...
                char idExcluirStr[10];

                printf("\nEscreva o numero da conta a ser excluida: ");
                fgets(idExcluirStr, sizeof(idExcluirStr), stdin);
                strtok(idExcluirStr, "\n");
                ...
                while (1)
                {
                    if (!apenasNumero(idExcluirStr))
                    {
                        printf("Entrada invalida. Digite apenas numeros.\n");

                        printf("\nEscreva o numero da conta a ser excluida (ou 0 para sair): ");
                        fgets(idExcluirStr, sizeof(idExcluirStr), stdin);
                        strtok(idExcluirStr, "\n");
                        continue;
                    }

                    if (apenasNumero(idExcluirStr) != (*cs)[i].id && apenasNumero(idExcluirStr) != '0')
                    {
                        printf("Entrada invalida. ID nao encontrado.\n");
